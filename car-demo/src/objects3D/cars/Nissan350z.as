...
public class Nissan350z extends CarBase
{
    ...
    public function Nissan350z(param1:ColorMaterial, param2:ColorMaterial, param3:ColorMaterial, param4:ColorMaterial)
    {
        ...
        var frPoint:Vector3D = new Vector3D(-148, 70, -265);
        var flPoint:Vector3D = new Vector3D(148, 70, -265);
        var brPoint:Vector3D = new Vector3D(-148, 70, 257);
        var blPoint:Vector3D = new Vector3D(148, 70, 257);
