...
public class MitsubishiLancerX extends CarBase
{
    ...
    public function MitsubishiLancerX(param1:ColorMaterial, param2:ColorMaterial, param3:ColorMaterial, param4:ColorMaterial)
    {
        ...
        var frPoint:Vector3D = new Vector3D(-146, 70, -257);
        var flPoint:Vector3D = new Vector3D(146, 70, -257);
        var brPoint:Vector3D = new Vector3D(-146, 70, 253);
        var blPoint:Vector3D = new Vector3D(146, 70, 253);
