...
public class OrbitControllerExtended extends Object implements ICamaraController
{
    ...
    public function OrbitControllerExtended(param1:Camera3D, param2:DisplayObject, param3:ObjectContainer3D = null)
    {
        ...
        this._stage = param2;
        this._target = param3;
        this.mainController = new HoverController(this._camera, this._target, 180, 20, this.fov, -20, 35, NaN, NaN, 6, 1);
    }
