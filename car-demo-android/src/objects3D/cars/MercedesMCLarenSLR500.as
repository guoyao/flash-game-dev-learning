...
public class MercedesMCLarenSLR500 extends CarBase
{
    ...
    public function MercedesMCLarenSLR500(param1:ColorMaterial, param2:ColorMaterial, param3:ColorMaterial, param4:ColorMaterial)
    {
        ...
        var frPoint:Vector3D = new Vector3D(-150, 70, -270);
        var flPoint:Vector3D = new Vector3D(150, 70, -270);
        var brPoint:Vector3D = new Vector3D(-154, 70, 265);
        var blPoint:Vector3D = new Vector3D(154, 70, 265);
