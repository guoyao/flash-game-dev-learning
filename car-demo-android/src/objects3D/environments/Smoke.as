package objects3D.environments
{
	...
	public class Smoke extends ObjectContainer3D 
	{
        ...
        [Embed(source="/../embeds/garage/yan.png", mimeType="image/png")]
		private var YanImg:Class;
		
		public function Smoke():void 
		{
			//step 1:we create one sample
			var material:ParticleBitmapMaterial = new ParticleBitmapMaterial(new YanImg().bitmapData);
