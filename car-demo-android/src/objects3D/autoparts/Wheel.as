...
{
    [Embed(source="/../embeds/models/wheel.png")]
    private var WheelMapAsset:Class;
    
    [Embed(source="/../embeds/models/Wheel.3DS", mimeType="application/octet-stream")] 
    ...
    private function complete(event:AssetEvent):void
    {
        switch (event.asset.assetType)
        {
            case AssetType.MESH:
            {
                ...
                this.wheel.position = new Vector3D(0,0,0);
